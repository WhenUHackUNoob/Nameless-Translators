...
var defaultPermissionMessage = "You don't have the required permission to do this.";
var Command = /** @class */ (function () {
    function Command() {
        ...
        this.permissionMessage = defaultPermissionMessage;
        this.hidden = false;
        this.ownerOnly = false;
    }
    Command.prototype.preSetup = function (id) {
        this.id = id;
        this.setup();
    };
     ...
     */
    Command.prototype.run = function (_, __, msg) {
