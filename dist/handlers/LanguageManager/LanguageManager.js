...
var LanguageManager = /** @class */ (function () {
    ...
    LanguageManager.getString = function (user, key) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var data, languageCode, languageData, keys, result, _a, keys_1, key_1, i, k, v;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, LanguageModel_1.default.create({ userID: user, language: 'en' })];
                    case 2:
                        data = _b.sent();
                        _b.label = 3;
                    case 3:
                        languageCode = data.get('language');
                        languageData = this.languages.get(languageCode.toLowerCase());
                        keys = key.split('.');
                        result = languageData;
