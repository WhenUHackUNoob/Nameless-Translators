...
var WarnCommand = /** @class */ (function (_super) {
    ...
    WarnCommand.prototype.setup = function () {
        ...
        this.usage = "warn <@user/userid> [reason]";
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, member.send("You have been warned in " + ((_c = msg.guild) === null || _c === void 0 ? void 0 : _c.name) + " (" + ((_d = msg.guild) === null || _d === void 0 ? void 0 : _d.id) + ") with the reason: " + reason)];
                    case 4:
                        _f.sent();
                        msg.channel.send("Successfully warned **" + member.user.tag + "**");
                        return [2 /*return*/];
                }
            });
        });
